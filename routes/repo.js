...
exports.userfull = function( req, res ){
                ...
                Whales.find({},function(err, whales) {
                    if (err){
                        ...
                        Pages.find({},function(err, pages) {
                            if (err){
                                res.status(ERROR_SEARCH_PAGE_INTERNAL1).send({msg:"search only whales", whales : whales, error:err});

                            }else{

                                res.send({msg:"search repo",whales:whales,pages:pages});
                            }
                        });
                    }
                });
